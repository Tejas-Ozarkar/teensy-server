...
public class User extends TableImpl<UserRecord> {
    ...
    private static final long serialVersionUID = -1761310882;

    /**
     * The reference instance of <code>teensy.user</code>
     */
    ...
    /**
     * The column <code>teensy.user.id</code>.
     */
    ...
    /**
     * The column <code>teensy.user.firstName</code>.
     */
    public final TableField<UserRecord, String> FIRSTNAME = createField(DSL.name("firstName"), org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>teensy.user.lastName</code>.
     */
    public final TableField<UserRecord, String> LASTNAME = createField(DSL.name("lastName"), org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>teensy.user.username</code>.
     */
    ...
    /**
     * Create a <code>teensy.user</code> table reference
     */
    public User() {
    ...
    /**
     * Create an aliased <code>teensy.user</code> table reference
     */
